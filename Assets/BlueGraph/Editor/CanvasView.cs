...
namespace BlueGraph.Editor
{
    ...
    public class CanvasView : GraphView
    {
        ...
        public void Load(Graph graph, SerializedObject serializedGraph)
        {
            m_Graph = graph;
            m_SerializedGraph = serializedGraph;
        ...
        public void RemoveEdge(Edge edge, bool registerAsNewUndo)
        {
            var input = edge.input as PortView;
            var output = edge.output as PortView;
            if (input != null && input.node != null && input.node is NodeView in_view) {
                in_view.UpdateBinding();
            }
            if (output != null && output.node != null && output.node is NodeView out_view) {
                out_view.UpdateBinding();
            }
        ...
        void Refresh()
        {
            ...
            Load(m_Graph, m_SerializedGraph);
        }
